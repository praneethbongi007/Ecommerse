...
data.forEach(async (e) => {
    const { data: response } = await axios.post("http://localhost:8000/products/create", e,{
        headers: {
            "Authorization": "Bearer U2FsdGVkX18y99gT48pL3+3Kap9sl9hhbyOwvsC+XcjsWPywKqUxSZge+sNHd9+yxh1sdFC1pDh+XVX9HO+FN98ffFEw97T3lsqgchsQFu147Z1bmmUcQ+OwaTN24nFEj6hCUzJ83VVdqe9LBz9MIw=="
        }
